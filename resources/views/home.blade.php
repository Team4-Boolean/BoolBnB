...
<div class="container card-container-AuthLoginRegister">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center bg-success text-uppercase font-weight-bold">Ti diamo il benvenuto su BoolBnB</div>
                ...
                <div class="card-body">
                    ...
                    <div class="create text-center center-block">
                        ...
                        <a class="btn btn-primary btn-login" href="{{route('admin.houses.create')}}">Crea
                        ...
                        <a class="btn btn-primary btn-login" href="{{route('houses.index')}}">Cerca
